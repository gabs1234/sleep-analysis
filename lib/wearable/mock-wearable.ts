 ...
 * Silently generates realistic physiological sleep metrics for local testing
 * and offline operation without needing live cloud credentials.
 */
export class MockWearableProvider implements WearableProvider {
  readonly id = "mock";
  readonly name = "Smartwatch Simulator (Mock)";
  readonly description = "Generates silent realistic wearable sleep & HRV metrics";
